 ...
 * все три были одинаковыми строками, секция читалась стеной из десяти
 * абзацев.
 *
 ...
 * нужно не 10 иллюстраций, а 3 — по одной на категорию.
  ...
  return (
    ...
    >
      ...
      {/* ── Категория 1: процесс ─────────────────────────────────────────
          ...
          отвечают на домашнее задание → выносите тренировку на поле своей
          команды → разбираете результат с Гаджи Муслимовичем. Порядок ТЗ при
          этом не нарушен по составу, изменена только последовательность
          внутри категории.
