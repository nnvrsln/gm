 ...
 * вопрос «что я получу».
 *
 * С 03.09.2026 уроки есть у всех шести блоков, с 06.09.2026 — и результаты.
 * Оба пустых состояния секция всё равно обрабатывает (Q13) — «Программа
 * модуля утверждается», если нет уроков, и «Результат модуля утверждается»,
 * если нет результата. Сейчас обе ветки не срабатывают ни на одном блоке, но
 * остаются: заказчик правит программу по частям, и они уже дважды были нужны.
 *
  ...
  return (
    ...
    >
      ...
      {/* ── Статичная часть блока ────────────────────────────────────────
          ...
          уроками, но без результата (такое уже было — модуль 4 до 06.09.2026)
          под списком висела бы пустая плашка с рамкой в 25px высотой — она
          читается сломанной вёрсткой, а не «результат готовится». */}
