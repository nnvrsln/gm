 ...
 * непрозрачен.
 *
 * Схода в `bg-pitch` здесь больше нет: 06.09.2026 вернулся слайд 9, и слой
 * уехал к нему — он всегда у последней секции страницы, иначе гасит фон на
 * стыке двух. Этот слой уже жил в «Программе», в «Как проходит обучение», в
 * тарифах и здесь; в «Финальную цитату» он уезжает во второй раз.
 *
 * Ответ про обратную связь правится парой с составом тарифов: он перечисляет,
 * что даёт каждая ступень. По этой связке 03.09.2026 из него ушла живая
 * встреча — подробности в комментарии у самого ответа в `data/faq.ts`.
 */
